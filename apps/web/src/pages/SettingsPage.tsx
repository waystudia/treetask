...
export function SettingsPage() {
  ...
  return (
    <div className="page settings-page">
      <PageHeader title="Настройки проекта" description="Участники, оформление и уведомления." action={<button className="button primary" type="button"><Save size={18} /> Сохранить</button>} />
