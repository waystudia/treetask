...
рабочими профилями, командами, измеримыми результатами и совместным Canvas.
Воронка показывает движение задач, выполненная работа выращивает дерево, а
подтверждённые результаты добавляют цветы и плоды.

Владелец или администратор проекта может нажать «Поделиться», получить
одноразовые ссылку и шестизначный код, а зарегистрированный участник — войти и
присоединиться к команде прямо с главной страницы.
